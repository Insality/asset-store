...
local property_entity_prefab = require("widget.Insality.debug_page_decore.properties_panel.property_entity_prefab")
local property_system = require("widget.Insality.debug_page_decore.properties_panel.property_system")
local M = {}
